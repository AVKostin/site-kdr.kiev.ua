<footer>
    <div class=fot-content>
		...
		<center><p span class="first-number" itemprop="streetAddress"><p>На время карантина прием\выдача заказов через Новую Почту</p></span></center>
...
{/literal}
{literal}
<script src="https://widget.chatbullet.com" data-id="4703176" defer></script>
{/literal}
...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter14128423 = new Ya.Metrika2({
                    id:14128423,
                    clickmap:true,
                    trackLinks:true,
